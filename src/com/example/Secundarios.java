...
public class Secundarios extends Personajes {
	...
	private double velocidadX;//velocidadX
	private double velocidadY;//velocidadY
	...
	* @param tiempo
	*/
	public void mueveX(double tiempo) {
		double aux;
		aux = posX + velocidadX; 
	...
	* @param tiempo
	*/
	public void mueveY(double tiempo, double aceleracion) {
		double aux;
